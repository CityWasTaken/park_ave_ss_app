    ...
    return (
        <Container>
            <Form onSubmit={handleSubmit} style={{ width: '500px' }} className="mx-auto mt-5" >
                <h2 className="text-center mt-3">Create A Pet</h2>
                ...
                <Form.Group className="mb-3">
                    ...
                    <Form.Control name="type" onChange={handleInputChange} value={formData.type} type="text" placeholder="What is the pet's type?" />
                </Form.Group>
